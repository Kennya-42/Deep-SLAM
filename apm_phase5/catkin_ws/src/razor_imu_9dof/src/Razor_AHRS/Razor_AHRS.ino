...
float ACCEL_X_MIN = -286; // Default: -250;
float ACCEL_X_MAX = 287;  // Default: 250;
float ACCEL_Y_MIN = -243; // Default: -250;
float ACCEL_Y_MAX = 311;  // Default: 250;
float ACCEL_Z_MIN = -294; // Default: -250;
float ACCEL_Z_MAX = 222;  // Default: 250;
...
const float magn_ellipsoid_center[3] = {94.6250, -47.1410, 313.802};
const float magn_ellipsoid_transform[3][3] = {{0.983284, -0.000225775, -0.00126110}, {-0.000225775, 0.947844, 0.0184375}, {-0.00126110, 0.0184375, 0.993375}};

// Gyroscope
// "gyro x,y,z (current/average) = .../OFFSET_X  .../OFFSET_Y  .../OFFSET_Z
float GYRO_AVERAGE_OFFSET_X = -16.46; // Default: 0.0;
float GYRO_AVERAGE_OFFSET_Y = 14.61;  // Default: 0.0;
float GYRO_AVERAGE_OFFSET_Z = 7.22;   // Default: 0.0;
